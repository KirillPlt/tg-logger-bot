...
def format_edited_message_diff(
    *,
    ...
    previous_payload = previous_snapshot.rendered_html if previous_snapshot is not None else None
    old_value = previous_payload or "<i>Неизвестно: предыдущая версия сообщения не была сохранена.</i>"
